...
export const sidebar: Record<string, DefaultTheme.Sidebar> = {
  'ru-RU': [
    ...
    },
    {
      ...
      items: [
        {
          text: 'Примеры сборки пакетов с использованием инструментов Альт',
          link: 'example/'
        },
        {
          text: 'Примеры сборки пакетов с исходными текстами на Python, Bash, С++',
          link: 'hello-world_example/'
        }
      ]
    }
  ]
