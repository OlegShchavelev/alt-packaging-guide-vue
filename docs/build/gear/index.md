...
Для того, чтобы сделать коммит очередной сборки пакета, необходимо использовать `gear-commit`, для формирования списока изменений на основе записи в Spec-файле:
